      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-4">TasteTrace</h3>
            <p className="text-gray-400 max-w-xs">
              Helping people connect food to symptoms, effortlessly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/">
                    <a className="text-gray-400 hover:text-white transition">Privacy</a>
                  </Link>
                </li>
                <li>
                  <Link href="/">
                    <a className="text-gray-400 hover:text-white transition">Terms</a>
                  </Link>
                </li>
                <li>
                  <Link href="/">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} TasteTrace. All rights reserved.
          </p>
